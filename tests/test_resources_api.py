...
class TestResourcesApi(unittest.TestCase):
    ...
    def setUp(self):
        #self.token_user = open('/tmp/token_super').readlines()[0].strip()
    ...
    def test_create_dataset(self):
        ...
        result = self.nd.create_dataset('test', 1, 1, 1, 1.0, 1.0, 1.0, is_public=1)
        self.assertEqual(result, True)
        self.nd.delete_dataset('test')
    ...
    def test_create_project(self):
        self.nd.create_dataset('test', 1, 1, 1, 1.0, 1.0, 1.0, 0)
        result = self.nd.create_project('testp', 'test', 'localhost', 1, 1, 'localhost', 'Redis')
        self.assertEqual(result, True)
    ...
    def test_get_project(self):
        self.nd.create_dataset('test', 1, 1, 1, 1.0, 1.0, 1.0, 0)
        self.nd.create_project('testp', 'test', 'localhost', 1, 1, 'localhost', 'Redis')
    ...
    def test_list_projects(self):
        ...
        self.nd.create_project('test1p', 'test', 'localhost', 1, 1, 'localhost', 'Redis')
        self.nd.create_project('test2p', 'test', 'localhost', 1, 1, 'localhost', 'Redis')
        self.nd.create_project('test3p', 'test', 'localhost', 1, 1, 'localhost', 'Redis')
    ...
    def test_create_channel(self):
        self.nd.create_dataset('test', 1, 1, 1, 1.0, 1.0, 1.0, 0)
        self.nd.create_project('testp', 'test', 'localhost', 1, 1, 'localhost', 'Redis')
        result = self.nd.create_channel('testc','testp', 'test', 'image', 'uint8', 0, 500, 0)
        self.assertEqual(result, True)
    ...
    def test_get_channel(self):
        self.nd.create_dataset('test', 1, 1, 1, 1.0, 1.0, 1.0, 0)
        self.nd.create_project('testp', 'test', 'localhost', 1, 1, 'localhost', 'Redis')
        self.nd.create_channel('testc','testp', 'test', 'image', 'uint8', 0, 500, 0)
